...
Random gam model, but removing species/stages that have < 400 positive observations available for modeling. These include the following species and stages: 
```{r}
